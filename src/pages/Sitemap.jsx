  ...
  const packageCategories = [
    {
      ...
      items: [
        ...
        'PandavaPura Kolhapur package',
        'Maa Kamakhya Package',
        'Kashi & Ayodya Package',
        'Gujurath',
        '3 Jothirlinga Package with shoridi'
      ]
    },
    {
            ...
            <div className="grid lg:grid-cols-2 gap-8">
              {packageCategories.map((category, index) => (
                <div key={index} className="bg-white rounded-xl shadow-lg p-8">
                  ...
                  <Link
                    to={category.title.includes('Member') && !category.title.includes('Non') ? '/packages/member' : '/packages/non-member'}
          ...
          <div className="mb-16">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
              <div className="bg-gradient-to-r from-blue-600 to-teal-600 rounded-xl p-6 text-white text-center">
                ...
                <Link to="/packages/member" className="bg-white text-blue-600 px-4 py-2 rounded-full text-sm font-semibold hover:bg-gray-100 transition-colors">
                  View Packages
                </Link>
              </div>
